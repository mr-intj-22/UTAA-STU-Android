...
public class DepartmentsDatabase {
    ...
    public DepartmentsDatabase(Context context) {
    ...
    public void deleteItem(int postId) {
        mDatabase.execSQL("DELETE FROM " + DatabaseHandler.TABLE_NAME + " WHERE postId = '" + postId + "'");
    }
    ...
    static class DatabaseHandler extends SQLiteOpenHelper {
        ...
        // Database Name
        static final String DATABASE_NAME = "Departments";
